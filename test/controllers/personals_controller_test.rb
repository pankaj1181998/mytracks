...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { date: @personal.date, email: @personal.email, from: @personal.from, seats: @personal.seats, to: @personal.to } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { date: @personal.date, email: @personal.email, from: @personal.from, seats: @personal.seats, to: @personal.to } }
