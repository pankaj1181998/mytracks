...
class MydbsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mydb" do
    assert_difference('Mydb.count') do
      post mydbs_url, params: { mydb: { email: @mydb.email, image: @mydb.image, title: @mydb.title, vid_link: @mydb.vid_link } }
    end
  ...
  test "should update mydb" do
    patch mydb_url(@mydb), params: { mydb: { email: @mydb.email, image: @mydb.image, title: @mydb.title, vid_link: @mydb.vid_link } }
